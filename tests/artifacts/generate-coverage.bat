...
echo.
echo Running coverage for simple.cfm...
call ant -buildfile="d:\work\script-runner" -DluceeVersion="7.0.0.370-SNAPSHOT" -Dwebroot="D:\work\lucee-extensions\extension-lcov\tests\artifacts" -Dexecute="/simple.cfm" -DluaceeVersionQuery="7/all/jar" -Ddebugger="false" -DFlightRecording="false" -DpostCleanup="false"
...
echo.
echo Running coverage for functions.cfm...
call ant -buildfile="d:\work\script-runner" -DluceeVersion="7.0.0.370-SNAPSHOT" -Dwebroot="D:\work\lucee-extensions\extension-lcov\tests\artifacts" -Dexecute="/functions.cfm" -DluaceeVersionQuery="7/all/jar" -Ddebugger="false" -DFlightRecording="false" -DpostCleanup="false"
...
call ant -buildfile="d:\work\script-runner" -DluceeVersion="7.0.0.370-SNAPSHOT" -Dwebroot="D:\work\lucee-extensions\extension-lcov\tests\artifacts" -Dexecute="/runner.cfm" -DluaceeVersionQuery="7/all/jar" -Ddebugger="false" -DFlightRecording="false" -DpostCleanup="false"
