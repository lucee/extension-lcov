component extends="org.lucee.cfml.test.LuceeTestCase" labels="lcov" {
    ...
    function testGenerateHtmlMinimal() {
        ...
        expect(result.stats).toHaveKey("totalLines");
        expect(result.stats).toHaveKey("coveredLines");
    ...
    function testGenerateHtmlContentStructure() {
        ...
        var indexContent = fileRead(result.htmlIndex);
        expect(indexContent).toInclude("<html", "Should be valid HTML");
        expect(indexContent).toInclude("coverage", "Should contain coverage information");
        expect(indexContent).toInclude("%", "Should show percentage coverage");
    }
}